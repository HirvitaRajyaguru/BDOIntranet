...
var strings = require("BirthdaysWebPartStrings");
var Birthdays_1 = require("./components/Birthdays");
var BirthdaysWebPart = /** @class */ (function (_super) {
    ...
    BirthdaysWebPart.prototype.render = function () {
        ...
        this.context.msGraphClientFactory.getClient().then(function (msGraphClient) {
            var element = React.createElement(Birthdays_1.default, {
...
exports.default = BirthdaysWebPart;
