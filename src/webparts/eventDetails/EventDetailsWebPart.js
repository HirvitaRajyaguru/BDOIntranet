...
var strings = require("EventDetailsWebPartStrings");
var EventDetails_1 = require("./components/EventDetails");
var sp_core_library_2 = require("@microsoft/sp-core-library");
var sp_http_1 = require("@microsoft/sp-http");
var moment = require("moment");
var EventDetailsWebPart = /** @class */ (function (_super) {
    __extends(EventDetailsWebPart, _super);
    function EventDetailsWebPart() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._listsInThisSite = [];
        return _this;
    }
    EventDetailsWebPart.prototype.onInit = function () {
        var _this = this;
    ...
    EventDetailsWebPart.prototype.render = function () {
        var element = React.createElement(EventDetails_1.default, {
    ...
    EventDetailsWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(EventDetailsWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    EventDetailsWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    groups: [
    ...
    EventDetailsWebPart.prototype.fetchLists = function (url) {
    ...
    EventDetailsWebPart.prototype.fetchOptions = function () {
    ...
    EventDetailsWebPart.prototype.onEventStartDateValidation = function (date) {
    ...
    EventDetailsWebPart.prototype.onEventEndDateValidation = function (date) {
        if (date && this.properties.eventEndDate.value) {
    ...
    return EventDetailsWebPart;
}(sp_webpart_base_1.BaseClientSideWebPart));
exports.default = EventDetailsWebPart;
//# sourceMappingURL=EventDetailsWebPart.js.map