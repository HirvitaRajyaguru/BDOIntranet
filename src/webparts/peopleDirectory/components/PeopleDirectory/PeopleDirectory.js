...
var PeopleDirectory = /** @class */ (function (_super) {
   ...
   */
    PeopleDirectory.prototype._loadPeopleInfo = function (index, searchQuery) {
        ...
        var query = searchQuery === null ? "FirstName:" + index + "*" : searchQuery.replace(/'/g, "''");
        ...
        this.props.spHttpClient
            ...
            var people = res.PrimaryQueryResult.RelevantResults.Table.Rows.map(function (r) {
                return {
                    ...
                    photoUrl: "" + _this.props.webUrl + ("/_layouts/15/userphoto.aspx?size=M&accountname=" + _this._getValueFromSearchResult('WorkEmail', r.Cells)),
    ...
    PeopleDirectory.prototype.render = function () {
        ...
        return (React.createElement("div", { className: PeopleDirectory_module_scss_1.default.peopleDirectory },
            React.createElement("div", { className: PeopleDirectory_module_scss_1.default.container },
                React.createElement("p", { className: PeopleDirectory_module_scss_1.default.header }, "Company Directory"),
                !loading &&
                    errorMessage &&
