...
export default class AllKeyDocuments extends React.Component<IKeyDocumentsProps, IKeyDocumentsState> {
          ...
          <div className={`ms-Grid ${styles.keyblk}`} dir="ltr">
            {this.state.items.map((item, key) => {
              return (<div className="ms-Grid-row">
                ...
                <Link href={`${this.props.siteurl}/SitePages/KeyDocument.aspx`} target='_blank' className={styles.viewAll}>
                  View More
                </Link>
