...
var IndexNavigation = /** @class */ (function (_super) {
    ...
    IndexNavigation.prototype.render = function () {
        ...
        var indexes = az.map(function (index) { return React.createElement(PivotItem, { linkText: index, itemKey: index, key: index }); });
        // as the last tab in the navigation, add the Search option
        indexes.push(React.createElement(PivotItem, { linkText: strings.SearchButtonText, itemKey: 'Search' },
        ...
        return (React.createElement("div", { className: styles.indexNavigation },
            React.createElement(Pivot, { onLinkClick: this._handleIndexSelect, selectedKey: this.props.selectedIndex }, indexes)));
    };
