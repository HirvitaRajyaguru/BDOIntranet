...
var PeopleDirectory_1 = require("./components/PeopleDirectory/PeopleDirectory");
var PeopleDirectoryWebPart = /** @class */ (function (_super) {
    ...
    PeopleDirectoryWebPart.prototype.render = function () {
        var _this = this;
        var element = React.createElement(PeopleDirectory_1.default, {
    ...
    PeopleDirectoryWebPart.prototype.onDispose = function () {
