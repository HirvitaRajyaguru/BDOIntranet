...
var HolidayCalendar = /** @class */ (function (_super) {
    ...
    HolidayCalendar.prototype.render = function () {
        return (React.createElement("div", { className: styles.holidayCalendar }, (this.props.Homepage == true) ? (React.createElement("div", { className: styles.container },
            React.createElement("div", { className: styles.header }, "HOLIDAY CALENDAR"),
            React.createElement("div", { className: "ms-Grid", dir: "ltr" }, (this.state.isLoading) ? React.createElement(Loader, { message: "Please wait..." }) :
                (this.state.items.length <= 0)
                    ?
                        React.createElement("div", null,
                            React.createElement("div", { className: "ms-Grid-row" },
                                React.createElement("div", { className: "ms-Grid-col md-sm6 md-md6" },
                                    React.createElement("div", { className: styles.titledetails }, " No Holiday to display"))))
                    :
                                ...
                                React.createElement("div", { className: "ms-Grid-row" },
                                    React.createElement("div", { className: "ms-Grid-col md-sm6 md-md6" },
                                        React.createElement("div", { className: styles.box },
                                            ...
                                            React.createElement("div", { className: styles.dateinline },
                                                React.createElement("div", { className: styles.titledisplay },
                                                    " ",
                                                    (new Date(item.DateOfHoliday).toDateString().substring(4, 7))),
                                                React.createElement("div", { className: styles.titlesub },
                                                    " ",
                                                    (new Date(item.DateOfHoliday).toDateString().substring(11, 15)))))),
                                    React.createElement("div", { className: "ms-Grid-col md-sm6 md-md6" },
                                        React.createElement("div", { className: styles.titledetails },
                                            " ",
                                            item.Title)))));
                            //}
                        }))),
            React.createElement(Link, { href: this.props.siteurl + "/SitePages/Holidays.aspx", target: '_blank', className: styles.viewAll }, "view more"))) : (React.createElement(HolidayCalendarDetail, { siteurl: this.props.siteurl, listId: this.props.listId, graphClient: this.props.graphClient, Homepage: this.props.Homepage }))));
    };
