...
import AllSpotlight from './AllSpotlight';
...
var Spotlight = /** @class */ (function (_super) {
    ...
    function Spotlight(props, state) {
            ...
            items: [
                {
                    ...
                    MediaHouse: '',
                    HeadLine: 'No SpotLights to Display',
                    RespectivePageLink: {
                        Url: ''
                    }
                }
    ...
    Spotlight.prototype.componentDidMount = function () {
        this.getSpotlightRecords();
    };
    Spotlight.prototype.componentWillReceiveProps = function (nextProps) {
        this.getSpotlightRecords();
    };
    //get StarPerformer's Records
    Spotlight.prototype.getSpotlightRecords = function () {
        var _this = this;
        ...
        if (this.props.Practices == true) //filter by expiryDate and Practices
            query = "?$select=EmployeeName/JobTitle,EmployeeName/EMail,EmployeeName/FirstName,EmployeeName/LastName,EmployeeName/EMail,MediaHouse,HeadLine,RespectivePageLink&$expand=EmployeeName/Id";
        else
            query = "?$select=EmployeeName/JobTitle,EmployeeName/EMail,EmployeeName/FirstName,EmployeeName/LastName,EmployeeName/EMail,MediaHouse,HeadLine,RespectivePageLink&$expand=EmployeeName/Id";
    ...
    Spotlight.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.spotlight }, (this.props.Homepage == true) ? (React.createElement("div", { className: styles.container },
            React.createElement("h2", null, "SPOTLIGHTS"),
            // If data is null then will show message of "No SpotLights to Display"
            (this.state.items[0].HeadLine === "No SpotLights to Display")
                ?
                    React.createElement("div", { className: "ms-Grid " + styles.padnone, dir: "ltr" },
                        React.createElement("div", { className: "ms-Grid-row" },
                            ...
                            React.createElement("div", { className: "ms-Grid-col ms-sm9 ms-md9" },
                                React.createElement("div", { className: styles.spotdetails },
                                    React.createElement("h2", null, "No SpotLights to Display")))))
                :
                    React.createElement("div", { className: "ms-Grid " + styles.padnone, dir: "ltr" },
                        React.createElement(Slider, __assign({}, settings), this.state.items.map(function (item, key) {
                            return (React.createElement("div", { className: "ms-Grid-row" },
                                React.createElement("div", { className: "ms-Grid-col ms-sm3 ms-md3" },
                                    React.createElement("img", { src: _this.props.siteUrl + "/_layouts/15/userphoto.aspx?size=L&accountname=" + item.EmployeeName.EMail, style: { width: '100px' } })),
                                React.createElement("div", { className: "ms-Grid-col ms-sm9 ms-md9" },
                                    React.createElement("div", { className: styles.spotdetails },
                                        ...
                                        React.createElement("p", null,
                                            " ",
                                            item.EmployeeName.JobTitle),
                                        React.createElement("p", null, (item.MediaHouse).substring(0, 150)),
                                        React.createElement("p", null,
                                            " ",
                                            item.HeadLine,
                                            React.createElement("a", { href: item.RespectivePageLink.Url, className: styles.readmore, target: "_blank" }, "Read More"))))));
                        }))),
            React.createElement(Link, { href: this.props.siteUrl + "/SitePages/Spotlight.aspx", target: '_blank', className: styles.viewAll }, "view more"))) : (React.createElement(AllSpotlight, { siteUrl: this.props.siteUrl, listId: this.props.listId, numberOfSeconds: this.props.numberOfSeconds, Practices: this.props.Practices, Homepage: this.props.Homepage }))));
    };
    return Spotlight;
}(React.Component));
