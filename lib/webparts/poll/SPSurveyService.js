 ...
 */
var SPSurveyService = /** @class */ (function () {
    /**
     * @function
     * Service constructor
     */
    ...
    SPSurveyService.prototype.getResults = function (surveyListId, question, choices) {
        ...
        return this.context.spHttpClient.get(restUrl, SPHttpClient.configurations.v1).then(function (response) {
    ...
    SPSurveyService.prototype.postVote = function (surveyListId, question, choice) {
        ...
        return this.getListName(surveyListId).then(function (listName) {
            ...
            return _this.context.spHttpClient.post(restUrl, SPHttpClient.configurations.v1, options).then(function (response) {
                return response.json().then(function (responseFormated) {
                    return true;
                });
            });
    ...
    SPSurveyService.prototype.getListName = function (listId) {
        ...
        return this.context.spHttpClient.get(restUrl, SPHttpClient.configurations.v1, options).then(function (response) {
        ...
        return this.context.spHttpClient.get(restUrl, SPHttpClient.configurations.v1).then(function (response) {
            return response.json().then(function (responseFormated) {
                ...
                responseFormated.value.map(function (object, i) {
                    var authorEmail = object['Author'].EMail.toLowerCase();
                    if (authorEmail == userEmail.toLowerCase()) {
                        var spListItem = {
                            'ID': '',
    ...
    SPSurveyService.prototype.getItemsFromMock = function (libId) {
        return MockHttpClient.getListsItems(this.context.pageContext.web.absoluteUrl).then(function () {
            var listData = { value: [] };
            if (libId == '1') {
                listData = {
                    value: [
