...
var Tiles = /** @class */ (function (_super) {
    ...
    Tiles.prototype.componentWillReceiveProps = function (nextprops) {
        this.getTiles();
    };
    //get tile's data
    Tiles.prototype.getTiles = function () {
        var _this = this;
        ...
        return (React.createElement("div", { className: styles.tiles },
            React.createElement("div", { className: styles.container },
                this.state.listData.map(function (item) {
                    return React.createElement(TilesItem, { title: item.Title, description: item.Description, imageUrl: item.ImageUrl, href: item.LinkUrl });
                }),
